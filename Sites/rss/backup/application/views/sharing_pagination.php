...
<body>
<form action="<?php echo base_url()."index.php/rss/find";?>" method="post" name="share" >
    <div class="container">
    <!-- HEADER -->
        <div class="wrapper">
            <div class="bg-header">
                   ...
                   <div class="row">
                        ...
                        <div class="footer-table">
						  ...
						  <!--<?php 
							echo $pagination;
						  ?>-->
                            <a href="<?php echo base_url().'index.php/rss/sharing/' ?>"><img src="<?php echo image_asset_url('table/pev.png')?>" style="margin: -5px 10px 0;"></a>
							<!--<span style="margin-top: 10px;">
								<input type="hidden" name="temp" value="">
								<input type="textbox" id="link" name="link" style="width: 15%;text-align:right;" value="<?php
								$i = "";
								if ($this->uri->segment(3)/20 == 0)
									echo $i = 1; 
								else if ($this->uri->segment(3)/20 == 1)
									echo $i = 2;
								else if ($this->uri->segment(3)/20 < 0)
									echo $i = 1;
								else
									echo $i = ($this->uri->segment(3)/20)+1;
							...
							<?php
								...
								$e = $query9-20;
							?>
                            <a href="<?php echo base_url()."index.php/rss/sharing/".$n ?>"><img src="<?php echo image_asset_url('table/next.png')?>" style="margin: -5px 10px 0;"></a>
                            <a href="<?php echo base_url()."index.php/rss/sharing/".$e ;?>"><img src="<?php echo image_asset_url('table/end.png')?>" style="margin: -5px 10px 0;"></a>
							<?php
							}
							else
							{?>
...
function jumpPage(){
	...
	if(page == 1)
	{
		var link="<?php echo base_url()?>index.php/rss/sharing/";
		//alert(link);
		window.location.replace(link);
	}
	else if(page == 2)
	{
		var link="<?php echo base_url()?>index.php/rss/sharing/20";
			//alert(link);
		window.location.replace(link);
	}
	else if(page > 2)
	{
		var link="<?php echo base_url()?>index.php/rss/sharing/"+(page-1)*20;
			//alert(link);
		window.location.replace(link);
	}
	else
...
$('#TypeID').change(function(){
    ...
    if (type_id != ""){
			...
			$.ajax({
				 ...
				 url: post_url,
				 dataType :'json',
				 success: function(subtype) //we're calling the response json array 'cities'
				  {
