...
<body>
<form action="<?php echo base_url()."rss/find";?>" method="post" name="share" >
    <div class="container">
    <!-- HEADER -->
        <div class="wrapper">
            <div class="bg-header">
                          ...
                          <div class="row">
                           ...
                           <div class="row">
									...
									<option value="">เลือกหมวดหมู่ข่าว</option>
									 <?php foreach ($newstype as $item2){;
									  if ( isset( $_POST['TypeID'] ) and ( $_POST['TypeID'] == $item2->NT02_TypeID ) ) {
										echo $selectedTypeID = ' Selected ';
									  } else {
										echo $selectedTypeID = '';
									  }
									?>
									 <option value="<?php echo $item2->NT02_TypeID; ?>" <?php echo $selectedTypeID; ?> ><?php echo $item2->NT02_TypeName; echo $selectedTypeID?></option>
								  <?php };?>
                                    </select>
                                    </span> 
                              </div>
                              <div class="col-lg-6">
								...
								?>
								<option value="<?php echo $item3->NT03_SubTypeID; ?>" <?php echo $selectedSubTypeID; ?> ><?php echo $item3->NT03_SubTypeName; ?></option>
								  <?php };?>
								  </select>
								  </span>
                              </div>
                         ...
                         <div class="row">
                              <div class="col-lg-6">
								  ...
								  if ( isset( $_POST['DepartmentID'] ) and ( $_POST['DepartmentID'] == $item4->SC07_DepartmentId ) ) {
									$selectedDepTypeID = ' Selected ';
								  } else {
									$selectedDepTypeID = '';
								  }
								?>
                            <option value="<?php echo $item4->SC07_DepartmentId; ?>" <?php echo $selectedDepTypeID; ?> ><?php echo $item4->SC07_DepartmentName; ?></option>
								  <?php };?>
								  </select>
								  </span>
                              </div>
							  <div class="col-lg-6">
								  ...
								  if ( isset( $_POST['UserId'] ) and ( $_POST['UserId'] == $item10->SC03_UserId ) ) {
									$selectedRepTypeID = ' Selected ';
								  } else {
									$selectedRepTypeID = '';
								  }
								?>
                            <option value="<?php echo $item10->SC03_UserId; ?>" <?php echo $selectedRepTypeID; ?> ><?php echo $item10->Name; ?></option>
								  <?php };?>
								  </select>
								  </span>
                              </div>
				   ...
				   <div class="row">
                        ...
                        <div class="footer-table">
                          ...
                          <p style="width: 70%;float: left;margin-top: 20px;">ทั้งหมด: <?php echo $rows; ?> รายการ (<?php echo ceil($rows/20) ?> หน้า)</p>   <p style="width: 30%;float: left;margin-top: 20px;text-align: right;">
                            <a href="<?php echo base_url().'rss/sharing/' ?>"><img src="<?php echo image_asset_url('table/pev.png')?>" style="margin: -5px 10px 0;"></a>
                            <span style="margin-top: 10px;">
                            <select id ="jump" name="jump" onchange="jumpPage()" class="select_page">
							...
							<?php
								...
								$e = $rows-20;
							?>
                            <a href="<?php echo base_url()."rss/sharing/".$n ?>"><img src="<?php echo image_asset_url('table/next.png')?>" style="margin: -5px 10px 0;"></a>
                            <a href="<?php echo base_url()."rss/sharing/".$e ;?>"><img src="<?php echo image_asset_url('table/end.png')?>" style="margin: -5px 10px 0;"></a>
							<?php
							}
							else
							{?>
...
function jumpPage(){
	...
	if(page == 1)
	{
		var link="<?php echo base_url()?>rss/sharing/";
		//alert(link);
		window.location.replace(link);
	}
	else if(page == 2)
	{
		var link="<?php echo base_url()?>rss/sharing/20";
			//alert(link);
		window.location.replace(link);
	}
	else if(page > 2)
	{
		var link="<?php echo base_url()?>rss/sharing/"+(page-1)*20;
			//alert(link);
		window.location.replace(link);
	}
	else
